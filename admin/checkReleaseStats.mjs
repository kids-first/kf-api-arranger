...
import { getGlobalClinicalStats, studiesStats, ENTITIES, isClinicalIndex } from './releaseStatsUtils.mjs';
...
const rAllCounts = await studiesStats(client, release, allIndices);
